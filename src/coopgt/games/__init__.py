"""
# Game generators (`tucoop.games`).

This subpackage contains convenience constructors for common transferable-utility
(TU) cooperative games. Each function returns a `tucoop.base.game.Game`
...
- The TU convention $v(\\varnothing)=0$ is enforced by `tucoop.base.game.Game`.

Examples
--------
>>> from tucoop.games import glove_game, weighted_voting_game
