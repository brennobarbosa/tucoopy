...
``tucoop.io.schemas`` and exposes small helpers to:
...
Examples
--------
>>> from tucoop.io.schema import animation_spec_schema
...
def _load_schema(filename: str) -> dict[str, Any]:
    root = resources.files("tucoop.io").joinpath("schemas")
...
def animation_spec_schema() -> dict[str, Any]:
    """
    Return the JSON Schema for the tucoop animation spec.
    """
