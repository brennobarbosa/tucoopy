...
- converters between `tucoop.base.game.Game` and a stable wire dict, and
...
with the schema files shipped in `tucoop.io.schemas`.

Examples
--------
>>> from tucoop.io.game_spec import spec_from_json
>>> spec = spec_from_json(
