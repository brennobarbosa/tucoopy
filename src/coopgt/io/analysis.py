...
>>> from tucoop.io.analysis import build_analysis
...
from ..base.exceptions import tucoopError
...
def build_analysis(
    ...
    *,
        ...
        if n <= int(max_players):
            ...
            analysis["solutions"] = {
                "shapley": {
                    ...
                    "meta": {"computed_by": "tucoop-py", "method": "shapley_value"},
                },
                "normalized_banzhaf": {
                    "allocation": normalized_banzhaf_value(game),
                    "meta": {"computed_by": "tucoop-py", "method": "normalized_banzhaf_value"},
                },
            }
    ...
    # ----------------------------
    # sets (STRICT to tucoop-animation.schema.json)
    # ----------------------------
    if include_sets and n <= int(max_players):
        ...
        sets["imputation"] = {"vertices": imp_vertices, "meta": {"computed_by": "tucoop-py", **imp_meta}}
        ...
        sets["core"] = {"vertices": core_v, "meta": {"computed_by": "tucoop-py", **core_meta}}
        ...
        sets["core_cover"] = {
            ...
            "meta": {"computed_by": "tucoop-py", **cc_meta},
        }
        ...
        sets["reasonable"] = {
            ...
            "meta": {"computed_by": "tucoop-py", **r_meta},
        }
        ...
        if include_weber:
            try:
                ...
                sets["weber"] = {
                    "points": pts,
                    "mean_marginal": mu,
                    "meta": {"computed_by": "tucoop-py", **pts_meta},
                }
