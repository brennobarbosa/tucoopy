...
- a sampling-based approach (via :func:`tucoop.geometry.sampling.sample_imputation_set`)
  for exploring candidate points when exhaustive checks are infeasible.

Notes
-----
This module is intended for use with `tucoop.geometry.ImputationSet` and
...
class Objection:
    ...
    Examples
    --------
    >>> from tucoop.geometry.bargaining_set import Objection
...
class CounterobjectionAttempt:
    ...
    Examples
    --------
    >>> from tucoop.geometry.bargaining_set import CounterobjectionAttempt
...
class BargainingCheckResult:
    ...
    Examples
    --------
    >>> from tucoop.geometry.bargaining_set import BargainingCheckResult
    ...
    **every** objection has a counterobjection.
    ...
    def sample_points(
        ...
        *,
        ...
        Procedure
        ---------
        1. Draw candidate points from the imputation set using `tucoop.geometry.sampling.sample_imputation_set`.
    ...
    def scan_imputation_grid(
        ...
        *,
        ...
        --------
        >>> from tucoop import Game
        >>> from tucoop.geometry import BargainingSet
