...
This module defines `tucoop.base.game.Game`, the main representation of a
...
- Coalitions are encoded as integer bitmasks (see `tucoop.base.coalition`).
...
class Game:
    ...
    # Convenience methods (thin wrappers around tucoop.properties).
    ...
    def is_superadditive(self, *, eps: float = 1e-12, max_players: int | None = 12) -> bool:
        ...
        This is a convenience wrapper around :func:`tucoop.properties.is_superadditive`.
    ...
    def is_convex(self, *, eps: float = 1e-12, max_players: int | None = 12) -> bool:
        ...
        This is a convenience wrapper around :func:`tucoop.properties.is_convex`.
    ...
    def is_essential(self, *, eps: float = 1e-12) -> bool:
        ...
        This is a convenience wrapper around :func:`tucoop.properties.is_essential`.
    ...
    def is_simple_game(self, *, tol: float = 0.0, max_players: int | None = 20) -> bool:
        ...
        This is a convenience wrapper around :func:`tucoop.properties.is_simple_game`.
    ...
    def validate_simple_game(self, *, tol: float = 0.0, max_players: int | None = 20) -> None:
        ...
        This is a convenience wrapper around :func:`tucoop.properties.validate_simple_game`.
