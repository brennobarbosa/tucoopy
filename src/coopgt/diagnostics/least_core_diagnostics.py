...
2. Reuses `tucoop.diagnostics.epsilon_core_diagnostics.epsilon_core_diagnostics`
...
>>> from tucoop.diagnostics.least_core_diagnostics import least_core_diagnostics
